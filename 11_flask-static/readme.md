...
1. As a team...
  ...
  - Note anything notable. 
            - When we attempt to open the file through the webpage, it automatically downloads the file.
  - Predict expected behaviors.
            - The HTML should load as a website
  - Spin up your website on localhost and reconcile behavior with prediction.
            - The HTML in fact DID load as a website when opened regularly, but when attempting to connect through web browser we encountered an error that said that our connection was not established.
